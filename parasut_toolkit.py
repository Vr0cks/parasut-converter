...
def sync_balances(api):
    ...
    if satis_listesi and os.path.exists("parasut_satis_faturalari (2).xlsx"):
        ...
        # Gizli İmza (VeryHidden Sheet)
        if "sys_meta" not in wb.sheetnames:
            ws_hidden = wb.create_sheet("sys_meta")
            ws_hidden.sheet_state = 'veryHidden'
            ws_hidden['A1'] = "Generated by vr0cks (https://yigit.vr0cks.com) - Non-Commercial Use Only"
